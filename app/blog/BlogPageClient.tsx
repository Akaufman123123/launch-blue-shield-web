      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <Link href="/blog/enterprise-device-management" onClick={scrollToTop}>
              <div className="relative h-48">
                <Image src="/images/de.png" alt="Enterprise Device Management" fill className="object-cover" />
              </div>
            </Link>
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Learn how enterprise device management solutions can secure and optimize your healthcare organization's
                mobile devices.
              </p>
              <Link
                href="/blog/enterprise-device-management"
